        ...
        <div className="max-w-[800px] mx-auto text-center">
          ...
          >
            <h2 className="display-title !text-white mb-8">
              Experience the True <br className="hidden md:block" /> Taste of Indore
            </h2>

            <p className="font-sans text-[16px] md:text-[19px] text-white/70 leading-[1.6] mb-12 font-medium max-w-[640px] mx-auto">
              Whether it&apos;s a daily snack or a festive gift, bring home the purity of Shahi Namkeen handcrafted with love.
            </p>
