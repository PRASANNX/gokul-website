                ...
                <div className="space-y-4 max-w-[420px]">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <button 
                      ...
                      className="btn-commerce btn-primary !py-5 w-full !text-[14px] !tracking-[0.1em] shadow-xl hover:-translate-y-1 transition-transform"
                    >
                      {messages.product.addToCart}
                    </button>
                    <Link
                      href="/checkout"
                      className="btn-commerce btn-secondary !py-5 w-full !text-[13px] !tracking-[0.1em] border-brand-dark/10 hover:border-brand-dark hover:bg-brand-cream/50"
                    >
                  ...
                  <div className="flex flex-col gap-3 pt-3">
                    <a 
                      ...
                      className="font-sans text-[12px] font-black uppercase tracking-widest text-[#25D366] hover:text-[#1ebe5d] transition-colors flex items-center justify-center gap-2 py-4 border border-[#25D366]/20 rounded-sm bg-[#25D366]/5 hover:bg-[#25D366]/10"
                    >
