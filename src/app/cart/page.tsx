        ...
        <div className="container-wide">
          <div className="flex flex-col lg:flex-row gap-12 items-start">
            ...
            <div className="w-full lg:w-1/3 bg-white border border-brand-border/10 p-8">
              ...
              <Link 
                href="/checkout"
                className="btn-commerce btn-primary w-full !py-5 flex items-center justify-center gap-3 mb-4 uppercase tracking-widest"
              >
              ...
              <a 
                ...
                className="btn-commerce btn-whatsapp w-full !py-4 flex items-center justify-center gap-3 mb-4 opacity-80 hover:opacity-100"
              >
